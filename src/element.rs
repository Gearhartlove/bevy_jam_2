...
impl Element {
    ...
    pub const SHAVED_ICE: Element = Element::new("Shaved Ice", "shaved_ice", "The most clean shaven ice you've ever seen. To bad you can't shave yourself like that.");
    ...
    pub const BREAD_DOUGH : Element = Element::new("Bread Dough", "bread_dough", "Bread dough that is slightly sticky. You don't know how it rose so fast, best not think about it to hard.");
    ...
    pub const DICED_CROUTONS: Element = Element::new("Diced Croutons", "diced_croutons", "Youre on a roll! After these croutons you'll be in para-dice.");
